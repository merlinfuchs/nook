    ...
    <div>
      <div className="prose prose-invert mx-auto my-20 px-3 md:px-5">
        ...
        <ul>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Nook, accessible from{" "}
              <a
                href="https://nooks.chat"
        ...
        <ul>
          ...
          <li>
            <p>Payment information (processed through Paddle.com)</p>
          </li>
        </ul>
        <h4>Usage Data</h4>
        ...
        <p>
          ...
          handled by Paddle.com, our third-party payment processor. When You
          make a payment, You will be redirected to Paddle&apos;s secure website
          where You will enter Your payment information directly. We do not
          store Your payment card details on our servers.
        </p>
        <p>
          Paddle.com may collect and process the following information from You:
        </p>
        <ul>
        ...
        <p>
          We share Your user ID and subscription details with Paddle.com to
          facilitate the payment process and manage Your subscription.
          Paddle.com has its own privacy policy and terms of service that govern
        ...
        <ul>
          <li>
            ...
            our Service, to contact You, and to process payments. This includes
            sharing Your user ID and other necessary information with
            Paddle.com, our payment processor, to facilitate subscription
            services.
          </li>
          <li>
        ...
        <ul>
          <li>By email: contact@nooks.chat</li>
        </ul>
      </div>
    </div>
  );
